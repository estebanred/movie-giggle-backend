...
router.route("/userwatched").get(function(req, res) {
...
router.route("/userwatched/:userID").get(function(req, res) {
...
router.route("/userwatched").delete(function(req, res) {
  UserWatched.findOneAndRemove({
    movieID: req.query.movieID,
    userID: req.query.userID
  }, function(err, userwatched) {
    if (err)
      res.send(err);
